    ...
    <div class="modal">
      ...
      <div class="modal-body">
        ...
        <div class="social-btns">
          <button class="social-btn" onclick="showToast('Google OAuth would connect here','info')">
          ...
          <button class="social-btn" onclick="showToast('GitHub OAuth would connect here','info')">
